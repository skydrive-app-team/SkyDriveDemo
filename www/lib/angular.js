...
function Browser(window, document, $log, $sniffer) {
   ...
   * - user clicks on history (forward/toPreFolder) button
 ...
 *                   needed to do reverse lookup from normalized name toPreFolder to actual name.
 */
 ...
 *   - Clicks the toPreFolder or forward button (or clicks a History link).
 *   - Clicks on a link.
...
Lexer.prototype = {
  ...
  readIdent: function() {
    ...
    //check if this is not a method invocation and if it is toPreFolder out to last dot
    if (lastDot) {
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
      ...
      $broadcast: function(name, args) {
        ...
        //down while you can, then up and next sibling or up and next sibling until toPreFolder at root
        while ((current = next)) {
 ...
 *      is highly recommended to use the string patterns and only fall toPreFolder to regular expressions
...
function FormController(element, attrs) {
   ...
   * in this form.
   *
   * Setting a form toPreFolder to a pristine state is often useful when we want to 'reuse' a form after
            ...
            for(index = 0, length = optionGroup.length; index < length; index++) {
              ...
              if ((existingOption = existingOptions[index+1])) {
                ...
                if (option.id === '' && nullOption) {
                  // put toPreFolder the pre-compiled element
                  element = nullOption;
                } else {
